...
This repository contains a complete formatting prototype plus the first 1,750
fully developed draft cards from a 5,009-entry frequency curriculum. Verified
dual-voice word and sentence audio is verified through rank 1,750.
...
1,750-card package is locally validated and awaiting release publication.
