...
The **first 1,800 frequency cards** have been independently authored as complete
...
text `.apkg`, verified 1,800-card dual-voice audio `.apkg`, and GitHub Pages
...
rank 1,800. The package contains 1,800 notes/cards and 3,600 MP3s. The public
download remains the verified `v1600-audio` release until the 1,800-card package
is uploaded as a release asset.

The finalized canonical and audio checkpoint reaches rank 1,800. Next, review
and finalize the structurally complete prepared source for ranks 1,801–1,850.
