...
The **first 1,750 frequency cards** have been independently authored as complete
...
text `.apkg`, verified 1,750-card dual-voice audio `.apkg`, and GitHub Pages
...
rank 1,750. The package contains 1,750 notes/cards and 3,500 MP3s. The public
download remains the verified `v1600-audio` release until the 1,750-card package
is uploaded as a release asset.

The finalized canonical and audio checkpoint reaches rank 1,750. Next, review
and finalize the structurally complete prepared source for ranks 1,751–1,800.
